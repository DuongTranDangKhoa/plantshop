<%-- 
    Document   : index
    Created on : Mar 2, 2023, 7:55:55 PM
    Author     : Khoa Duong
--%>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <form action="dispatch" method="GET">
                                    <button class="dropdown-item"  name="btAction" value="Signout">Sign Out</button>
                                    <button class="dropdown-item" name="btAction" value="change">Change profile</button>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="dispatch?txtsearch=&bysearch=byName&btAction=search&page=shop" class="nav-item nav-link">Shop</a>
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="images/img1.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Vanda</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">This is a Vanda</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="dispatch?txtsearch=&bysearch=byName&btAction=search&page=shop">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="images/img4.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">White rose</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">This is a rose</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="dispatch?txtsearch=&bysearch=byName&btAction=search&page=shop">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="images/img7.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Var Monstera</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Cay la kieng</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="dispatch?txtsearch=&bysearch=byName&btAction=search&page=shop">Shop Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        ...
                        <a href="dispatch?txtsearch=&bysearch=byName&btAction=search&page=shop" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
                <div class="product-offer mb-30" style="height: 200px;">
