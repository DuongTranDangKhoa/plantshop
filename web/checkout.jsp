                    ...
                    <div class="bg-light p-30 mb-5">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label>Name</label>
                                <input class="form-control" type="text" placeholder="John" value="<%= account.getFullnameString()%>">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Email</label>
                                <input class="form-control" type="text" placeholder="Doe" value="<%= account.getEmail()%>">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Phone</label>
                                <input class="form-control" type="text" value="<%= account.getPhone()%>">
                                <%--
                                b1 tao order bam checkout servlet tao order
                                b2 tao drderDetail i-s-i
                                b3 select money in orderdetail based on order id
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" type="text"  value="22/03/2023" readonly="" >
                                </div>
                            ...
                            <div class="border-bottom">
                                ...
                                <%
                                    ...
                                    for (PlantDTO plant : list) {
                                        subtotal += plant.getPrice() * cart.get(plant);
                                        %>
                                          
                                        <div class="d-flex justify-content-between">
                                            <p><%= plant.getName() %></p>
                                            <p>$<%= plant.getPrice() %> * <%= cart.get(plant) %>  =  $<%=plant.getPrice() * cart.get(plant)%></p>
                                        </div>
