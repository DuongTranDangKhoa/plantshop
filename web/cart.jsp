                ...
                <div class="col-lg-8 table-responsive mb-5">
                    <table class="table table-light table-borderless table-hover text-center mb-0">
                        ...
                        <h2 style="color: red">
                            ...
                            %>
                            <tr>
                                <td class="align-middle"><img src="<%= dto.getImgpath()%>" alt="" style="width: 50px;"> <%= dto.getName()%> </td>
                                <td class="align-middle"><%= dto.getPrice()%>$</td>
                                <td class="align-middle">
                                    <%--addToCartServlet?key=<%= plant.getId() %>&quantity=1&id=<%= plant.getId() %>&btAction=cart--%>
                                    ...
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        ...
                                        <input type="hidden" name="key" value="<%= dto.getId()%>" />
                                ...
                                <td class="align-middle"><%= dto.getPrice() * quantity%>$</td>
                                <td class="align-middle"><button name="btAction" value="remove" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></td>
                                </form>
                            </tr>
                            <%
                                        totalQuantity = list.size();
                                        sub = sub + dto.getPrice() * quantity;
                                    }
                                }
                    ...
                    <div class="bg-light p-30 mb-5">
                        <form action="dispatch">                        
                            ...
                            <div class="pt-2">
                                ...
                                <button name="btAction" value="checkout" type="submit" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Proceed To Checkout</button>
                            </div>
                        </form>
                    </div>
                </div>
